...
if __name__ == '__main__':
    ...
    h2dEdxVsMomentum.GetXaxis().SetTitle("#frac{q}{e} #times p [GeV/c]")
    h2dEdxVsMomentum.GetYaxis().SetTitle("dE/dx [GeV/cm]")
    h2dEdxVsMomentum.GetYaxis().SetRangeUser(0, 15e-6)
